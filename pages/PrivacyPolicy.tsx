...
const PrivacyPolicy = () => {
    return (
        <div>
            <Box p={5} m={2}>
            <Heading> This Privacy Policy applies to the tridosoft.com</Heading>
            <Text p={5} m={2} >
            tridosoft.com recognises the importance of maintaining your privacy. We value your privacy and appreciate your trust in us. This Policy describes how we treat user information we collect on https://tridosoft.com and other offline sources. This Privacy Policy applies to current and former visitors to our website and to our online customers. By visiting and/or using our website, you agree to this Privacy Policy.
            </Text>
